...
function About() {
  return <ArticlePanel column>
    ...
    <p><Text>Bangumi Research 是由<a href="https://chii.in/user/wattlebird" target="_blank" rel="noopener noreferrer">小乖</a>创建、展示其对 Bangumi 数据挖掘成果的网站。自 2015 年始小乖就已经在以不同的方式向 Bangumi 用户呈现具有洞察力的数据报告。欢迎访问<a href="https://ikely.me/tags/bangumi-research/" target="_blank" rel="noopener noreferrer">小乖的博客</a>以获取与该站相关的技术信息。</Text></p>
    ...
    <p>Bangumi Research LOGO 由<a href="https://chii.in/user/gracehuyelin" target="_blank" rel="noopener noreferrer">胡披萨</a>设计并授权该站使用。</p>
  </ArticlePanel>
